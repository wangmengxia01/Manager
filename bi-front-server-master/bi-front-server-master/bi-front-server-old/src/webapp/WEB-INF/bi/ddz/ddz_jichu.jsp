...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 斗地主人数信息</h4>
</div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 斗地主场次信息</h4>
</div>
<div class="row"></div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 斗地主抽水信息</h4>
</div>
<div class="row"></div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 斗地主不叫地主信息</h4>
</div>
<div class="row"></div>
...
<script>
    ...
    function download() {
        $('#iframe1').attr("src", "bi?input=ddz_downloadJichu"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
