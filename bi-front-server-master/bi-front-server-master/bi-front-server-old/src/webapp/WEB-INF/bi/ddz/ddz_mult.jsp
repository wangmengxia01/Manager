...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 初级场倍数</h4>
</div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 中级场倍数</h4>
</div>
<div class="row"></div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 高级场倍数</h4>
</div>
<div class="row"></div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 精英场倍数</h4>
</div>
<div class="row"></div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 大师场倍数</h4>
</div>
<div class="row"></div>
...
<script>
    ...
    function download() {
        $('#iframe1').attr("src", "bi?input=ddz_downloadMult"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
                + "&fileName=" + "ddz_Mult.csv");
    }
