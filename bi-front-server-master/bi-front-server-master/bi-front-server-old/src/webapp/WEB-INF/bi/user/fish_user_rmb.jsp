...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <div class="col-md-5 col-lg-5">
            <h1><i class="fa fa-money"></i> 用户人民币统计</h1>
        </div>
        ...
        <form>
            ...
            <div class="form-group col-md-2" style="width: 120px">
                <input type="text" class="form-control" id="jiage"
                       placeholder="弹头价格" required>
            </div>
        ...
        <div class="table-responsive">
            <table id="AllOnlineTable" class="table table-striped">
...
<script>
    ...
    $('.form_date').datepicker({format: "yyyy-mm-dd", language: "zh-CN", autoclose: true,pickerPosition:"bottom-down"});
    today();


    function query() {
        $.blockUI();
        $.post("bi?input=user_queryUserRMB", {
            ...
            $('#AllOnlineTable').html(res);
            $.unblockUI();
        });
    }

    function download() {
        $('#iframe1').attr("src", "bi?input=user_queryPayDetail"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
                + "&fileName=" + "queryPayDetail.csv");
    }
</script>
