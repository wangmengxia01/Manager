...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 用户赢钱记录</h4>
</div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 用户输钱记录</h4>
</div>
...
<script>
    ...
    function query() {
        ...
        $.blockUI();
        $.post("bi?input=singleUser_queryEnemy", {
    ...
    function download() {
        ...
        $('#iframe1').attr("src", "bi?input=singleUser_downloadEnemy"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "NONE"
                + "&userId=" + $('#userId').val()
                + "&fileName=" + "single_user_enemy.csv");
    }
