...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <div class="col-md-10 col-lg-10">
            <h1><i class="fa fa-money"></i> 每日新增用户后续付费查询</h1>
        </div>
...
<script>
    ...
    function query() {
        $.blockUI();
        $.post("bi?input=user_queryInstallPayDays", {
    ...
    function download() {
        $('#iframe1').attr("src", "bi?input=user_downloadInstallPayDays"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
