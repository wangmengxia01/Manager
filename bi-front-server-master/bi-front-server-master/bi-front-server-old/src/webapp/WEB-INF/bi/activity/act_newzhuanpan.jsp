...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li><a onclick="dezhou( 'myTabContent' );" href="#" data-toggle="tab">德州转盘活动</a></li>
            <li><a onclick="chaxun( 'myTabContent' );" href="#" data-toggle="tab">转盘玩家查询</a></li>
        </ul>
...
<script>
    ...
    function chaxun(id) {
        $.post("bi?input=act_getNewZhuanPanChaDZPage", function (res) {
            $('#' + id).html(res);
        });
    }
    function dezhou(id) {
        $.post("bi?input=act_getNewZhuanPanDZPage", function (res) {
            $('#' + id).html(res);
        });
    }
