...
<form>
    ...
    <div class="form-group col-md-2">
        <input type="text" class="form-control" id="actId"
               placeholder="期号" required>
    </div>
    <div class="form-group col-md-2">
...
<div class="table-responsive">
    <table id="table1" class="table table-striped" data-toggle="table">
...
<script>
    ...
    function query() {
        ...
        $.blockUI();
        $.post("bi?input=act_queryDanQiDanRen", {
    ...
    function download() {
        ...
        $('#iframe1').attr("src", "bi?input=act_downloadDanQiDanRen"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "NONE"
