...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li><a onclick="majiang( 'myTabContent' );" href="#" data-toggle="tab">德州圣诞活动</a></li>
            <li><a onclick="dezhou( 'myTabContent' );" href="#" data-toggle="tab">麻将圣诞活动</a></li>
        </ul>
...
<script>
    ...
    function majiang(id) {
        $.post("bi?input=act_getShengdanDZPage", function (res) {
            $('#' + id).html(res);
        });
    }
    function dezhou(id) {
        $.post("bi?input=act_getShengdanMJPage", function (res) {
            $('#' + id).html(res);
        });
    }
