...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li><a onclick="dezhou( 'myTabContent' );" href="#" data-toggle="tab">捕鱼万圣节活动</a></li>
...
<script>
    ...
    function chaxun(id) {
        $.post("bi?input=act_getNanGuaChaFishPage", function (res) {
            $('#' + id).html(res);
        });
    }
    function dezhou(id) {
        $.post("bi?input=act_getNanGuaFishPage", function (res) {
            $('#' + id).html(res);
        });
    }
