...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li><a onclick="majiang( 'myTabContent' );" href="#" data-toggle="tab">麻将挖矿产</a></li>
            <li><a onclick="dezhou( 'myTabContent' );" href="#" data-toggle="tab">德州挖矿产</a></li>
        </ul>
...
<script>
    ...
    function majiang(id) {
        $.post("bi?input=act_getKuangChanPageMJ", function (res) {
            $('#' + id).html(res);
        });
    }
    function dezhou(id) {
        $.post("bi?input=act_getKuangChanPage", function (res) {
            $('#' + id).html(res);
        });
    }
