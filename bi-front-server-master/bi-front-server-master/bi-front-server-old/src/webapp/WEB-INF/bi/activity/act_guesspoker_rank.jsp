...
<form>
    ...
    <div class="form-group col-md-2">
        ...
        <input id="limit" name="limit" type="hidden" value="1000000"/>
...
<script>
    ...
    function query() {
        $.blockUI();
        $.post("bi?input=act_queryGuessPokerRank", {
...
//    function download() {
//        $('#iframe1').attr("src", "bi?input=fishMB_downloadRank"
//                + "&timeBegin=" + $('#timeBegin').val()
//                + "&timeEnd=" + $('#timeEnd').val()
//                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
//                + "&timeInterval=" + "NONE"
//                + "&limit=" + $('#limit').val()
//                + "&fileName=" + "fish_rank.csv");
//    }
</script>
