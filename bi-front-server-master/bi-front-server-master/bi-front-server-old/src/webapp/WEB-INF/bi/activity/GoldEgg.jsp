...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <div class="col-md-5 col-lg-5">
            <h1><i class="fa fa-money"></i> 幸运金蛋</h1>
        </div>
        ...
        <div class="table-responsive">
            <table id="GoldEgg" class="table table-striped">
...
<script>
    ...
    function query() {
        $.blockUI();
        $.post("bi?input=act_queryGoldEgg", {
    ...
    //
    function download() {
        $('#iframe1').attr("src", "bi?input=act_downloadGoldEgg"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
                + "&fileName=" + "act_GoldEgg.csv");
    }
</script>
