...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <div class="col-md-5 col-lg-5">
            <h1><i class="fa fa-money"></i> 抽水率报表</h1>
        </div>
...
<script>
    ...
    function query() {
        $.blockUI();
        $.post("bi?input=summary_queryChoushuiLv", {
    ...
    function download() {
        $('#iframe1').attr("src", "bi?input=summary_downloadChoushuiLv"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
                + "&fileName=" + "summary_ChoushuiLv.csv");
    }
</script>
