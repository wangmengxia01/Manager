...
<div class="body slide">
    ...
    <div class="container-fluid left-border">
        ...
        <div class="col-md-5 col-lg-5">
            <h1><i class="fa fa-money"></i> 收入汇总</h1>
        </div>
        ...
        <form>
            ...
            <div class="form-group col-md-2">
                <input id="timeEnd" name="timeEnd" size="16" type="text" readonly
                       class="form-control form_date">
            </div>
        ...
        <div class="table-responsive">
            <table id="huizong" class="table table-striped">
...
<script>
    ...
    function query() {
        $.blockUI();
        $.post("bi?input=summary_queryInstallPayHuizong", {
    ...
    function download() {
        $('#iframe1').attr("src", "bi?input=summary_downloadInstallPayHuizong"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
                + "&fileName=" + "summary_InstallHuizong.csv");
    }
</script>
