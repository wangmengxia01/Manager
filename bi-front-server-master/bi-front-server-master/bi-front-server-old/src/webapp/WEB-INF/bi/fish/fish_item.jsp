...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 初级场道具</h4>
</div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 中级场道具</h4>
</div>
<div class="row"></div>
...
<div class="col-md-5 col-lg-5">
    <h4><i class="fa fa-money"></i> 高级场道具</h4>
</div>
<div class="row"></div>
...
<script>
    ...
    function download() {
        $('#iframe1').attr("src", "bi?input=fish_downloadItem"
                + "&timeBegin=" + $('#timeBegin').val()
                + "&timeEnd=" + $('#timeEnd').val()
                + "&offsetTimeZone=" + $('#offsetTimeZone').val()
                + "&timeInterval=" + "DAY"
                + "&fileName=" + "fish_item.csv");
    }
